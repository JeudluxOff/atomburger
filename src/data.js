export const menuSeed = [
  ...
  { id: 'chicken', category: 'Burgers', name: 'Cluckin Atom', description: 'Poulet croustillant, salade, tomate et sauce cremeuse.', price: 9.9, available: true },
  { id: 'veggie', category: 'Burgers', name: 'Green Fusion', description: 'Galette vegetale, cheddar, crudites et sauce douce.', price: 9.5, available: true },
  { id: 'fries', category: 'Accompagnements', name: 'Frites Atom', description: 'Frites dorees et salees, format genereux.', price: 3.5, available: true },
  { id: 'rings', category: 'Accompagnements', name: 'Onion Rings', description: 'Rondelles d oignon panees et croustillantes.', price: 3.9, available: true },
  { id: 'nuggets', category: 'Accompagnements', name: 'Nuggets x6', description: 'Six morceaux de poulet panes avec une sauce.', price: 5.2, available: true },
  { id: 'ecola', category: 'Boissons', name: 'eCola', description: 'Le classique bien frais.', price: 2.5, available: true },
  { id: 'sprunk', category: 'Boissons', name: 'Sprunk', description: 'Citronne, frais et nerveux.', price: 2.5, available: true },
  { id: 'energy', category: 'Boissons', name: 'Junk Energy', description: 'Une dose d energie pour le trajet.', price: 3.2, available: true },
  { id: 'water', category: 'Boissons', name: 'Eau plate', description: 'Simple, fraiche, efficace.', price: 1.8, available: true },
  { id: 'shake', category: 'Desserts', name: 'Jumbo Shake', description: 'Vanille, chocolat ou fraise.', price: 4.9, available: true },
  { id: 'cookie', category: 'Desserts', name: 'Cookie geant', description: 'Cookie XL aux pepites de chocolat.', price: 3.5, available: true },
  { id: 'donut', category: 'Desserts', name: 'Donut', description: 'Donut moelleux au glacage sucre.', price: 2.9, available: true },
]
...
export const restaurantsSeed = [
  ...
  { id: 'sandy', name: 'Sandy Shores', hours: '12:00 - 23:00', phone: '555-ATOM-04', x: 59, y: 47, active: true },
]

export const staffSeed = [
  { id: 'staff-1', username: 'directeur', email: 'directeur@atom.sa', password: 'atom', firstName: 'Ethan', lastName: 'Reagan', role: 'Directeur Restaurant', position: 'Direction', restaurant: 'Vinewood Boulevard', phone: '555-0101', iban: 'SA01 ATOM 0000 0001', permissions: ['calendar', 'orders', 'admin'] },
  { id: 'staff-2', username: 'manager', email: 'manager@atom.sa', password: 'atom', firstName: 'Lena', lastName: 'Breeks', role: 'Manager', position: 'Responsable de service', restaurant: 'Vespucci Beach', phone: '555-0102', iban: 'SA01 ATOM 0000 0002', permissions: ['calendar', 'orders', 'admin'] },
  { id: 'staff-3', username: 'equipier', email: 'equipier@atom.sa', password: 'atom', firstName: 'Riley', lastName: 'Morales', role: 'Equipier polyvalent', position: 'Caisse et cuisine', restaurant: 'Legion Square', phone: '555-0103', iban: 'SA01 ATOM 0000 0003', permissions: ['calendar', 'orders'] },
  { id: 'staff-4', username: 'stagiaire', email: 'stagiaire@atom.sa', password: 'atom', firstName: 'Kaito', lastName: 'Takashi', role: 'Stagiaire equipier', position: 'Formation', restaurant: 'Sandy Shores', phone: '555-0104', iban: 'SA01 ATOM 0000 0004', permissions: ['calendar', 'orders'] },
]
...
export const eventSeed = [
  { id: 'event-1', title: 'Brief equipe', date: new Date().toISOString().slice(0, 10), start: '19:00', end: '19:30', type: 'Reunion', location: 'Vinewood Boulevard', notes: 'Points du service et repartition des postes.', authorId: 'staff-1' },
  { id: 'event-2', title: 'Animation mascotte', date: new Date(Date.now() + 86400000 * 2).toISOString().slice(0, 10), start: '20:00', end: '22:00', type: 'Animation', location: 'Legion Square', notes: '', authorId: 'staff-2' },
]
